<div class="flex">
    ...
    >
        ...
        <button type="submit" class="flex items-center mr-4 {{ $pull->isLikedBy(current_user()) ? 'text-orange' : 'text-gray' }}">
    ...
    >
        ...
        <button type="submit" class="flex items-center {{ $pull->isDislikedBy(current_user()) ? 'text-orange' : 'text-gray' }}">
            <svg class="fill-current mr-1 w-6"

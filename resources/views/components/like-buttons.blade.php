<div class="flex">
    ...
    >
        ...
        <button type="submit" class="flex items-center mr-4 {{ $pull->isLikedBy(current_user()) ? 'text-orange' : 'text-black' }}">
    ...
    >
        ...
        <button type="submit" class="flex items-center {{ $pull->isDislikedBy(current_user()) ? 'text-orange' : 'text-black' }}">
            <svg class="fill-current mr-1 w-6"
